...
public class NonVegActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		back.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				Intent it=new Intent(NonVegActivity.this,FoodlistActivity.class);
				startActivity(it);
				finish();
		...
		front.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				Intent it=new Intent(NonVegActivity.this,HygenieActivity.class);
				startActivity(it);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.activity_non_veg, menu);
		return true;
	}
