...
public class TobaccoActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		back.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				Intent it=new Intent(TobaccoActivity.this,MorningsicknessActivity.class);
				startActivity(it);
				finish();
			}
		});
		front.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				Intent it=new Intent(TobaccoActivity.this,CausesActivity.class);
				startActivity(it);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.activity_tobacco, menu);
		return true;
	}
