...
public class VitaminsActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		back.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				Intent it=new Intent(VitaminsActivity.this,NutsActivity.class);
				startActivity(it);
				finish();
			}
		});
		front.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				Intent it=new Intent(VitaminsActivity.this,DontsActivity.class);
				startActivity(it);
				finish();
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.activity_vitamins, menu);
		return true;
	}
